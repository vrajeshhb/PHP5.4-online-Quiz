...
table{
	...
	{
	$sql = "insert `quiz`.`mst_subject` (`sub_id`, `sub_name`) VALUES (NULL,'".$_POST['subname']."')";
	$result = mysql_query($sql);
	if (!$result)
	{
	}
	else{echo '<p style="color:red;">SUBJECT Added.. </p>';}
	}?>
					<h4 ><u>Add SUBJECT. </u></h4>
