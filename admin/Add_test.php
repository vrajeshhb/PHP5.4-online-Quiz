...
{
mysql_query("insert into mst_test(sub_id,test_name,total_que) values ('".$_POST['subid']."', '".$_POST['testname']."', '".$_POST['totque']."' )");
...
<form name="form1" action="Add_test.php" method="post" onSubmit="return check();">
