		...
		<main role="main">
			...
			<div id="fh5co-intro">
				<div class="container">
					...
					<h4>Your Score Details : </h4>
					<table width="850" class="altrowstable" id="alternatecolor">
						<tr style="background-image:url(../images/work_6.jpg)">
							<td colspan="7"></td>
						</tr>
<?php						$s = "SELECT * FROM  `mst_result` where login = '".$_SESSION['user']."' ORDER BY  `mst_result`.`test_date` DESC" ;			
							$q=mysql_query($s);
							/*if (!$q)
							{
								echo "error #1";
...
?>
					...
					<?php }?>
					<br><br>
					<h4>Your Score Details :</h4><br>
					<form action="index.php" method="post">
					<table style="font-size:16px;font-weight:bold;" width="850" class="altrowstable" id="alternatecolor">
			<tr style="background-image:url(../images/work_6.jpg)">
					<td colspan="7"></td>
			...
			<tr style="background-image:url(../images/work_7.jpg)"> 
					<tr style="background-image:url(../images/work_7.jpg)">
							...
							<td width="150">TEST ID :</td>
							<td width="150">TEST DATE :</td>
							<td width="150">YOUR SCORE : </td>
						</tr>
						
			</tr>
			<?php 
			
			$sql = "SELECT * FROM  `mst_result` where login = '".$_SESSION['user']."' ORDER BY  `mst_result`.`test_date` DESC" ;			
			$q=mysql_query($sql);
$no=0;
while($res=mysql_fetch_array($q))
{
...
?>
			...
			<tr>
							...
							<td width="150"><?php echo $res[2]; ?></td>
							<td width="150"><?php echo $res[3]; ?></td>
						</tr>
