<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql="select * from mst_user where login = '$uname' and pass= '$pass' ";
		$res=mysql_query($sql);
			...
			<div class="container">
					...
					<center>
						<p class="fh5co-copyright">
							<small>(c)IMS 2019 <a href="../index.php">IMS</a>. All Rights Reserved.<br> <a href="../admin/login.php">(ADMIN LOGIN) </a></small>
						</p>
					</center>
